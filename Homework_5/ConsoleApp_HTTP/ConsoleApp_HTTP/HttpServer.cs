        ...
        private async Task ProcessRequests()
        {
            while (_server.IsListening)
            {
                try
                {
                    ...
                    if(path.Contains("svg")) response.Headers.Add("Content-Type", "image/svg+xml");
                    if(path.Contains("jpeg")) response.Headers.Add("Content-Type", "image/jpeg");
                    if(path.Contains("jpg")) response.Headers.Add("Content-Type", "image/jpeg");
